...
public class DriveSubsystem extends SubsystemBase {
  ...
  public DriveSubsystem() {
    ...
    AutoBuilder.configure(
        ...
        this::resetOdometry, // Odometry reset method
        this::RobotRelativSpeeds, // Robot velocity supplier
        this::driveRobotRelative,// Method to drive the robot
        new PPHolonomicDriveController(
          Constants.DriveConstants.kTranslationPID,
          Constants.DriveConstants.kRotationPID
        ),
        config,
        () -> {
